  ...
  return (
    <div>
      <PageHeader
        ...
        breadcrumbs={[
          { label: 'Ventas', href: '/sistema/ventas' },
          { label: venta.folio },
        ]}
      />
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card className={venta.garantia.activa && !garantiaExpirada ? 'garantia-activa' : 'garantia-expirada'}>
            ...
            <CardBody>
              <Link
                href={`/sistema/garantias/${venta.garantia.id}`}
              ...
              <div className="mt-4 pt-4 border-t border-[var(--border-color)]">
                <p className="text-xs text-[var(--text-muted)]">Condiciones:</p>
                <p className="text-sm mt-1">{venta.garantia.condiciones}</p>
              </div>
            </CardBody>
          </Card>
